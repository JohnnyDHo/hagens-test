...
export const progressPieces: readonly ProgressPiece[] = [
  ...
  },
  {
    ...
    status: "IN REVIEW",
    round: 2,
    latestVerdict: "Builder removed fabricated data; independent re-review pending.",
    biggestGap: "Source-truth and rendered recheck pending.",
    checkpoint: "P02 · R2 · BUILD",
  },
  {
    id: 3,
    name: "Global shell",
